...
class DialogueState(BaseModel):
    ...
    # Indicates that all fields have been populated at least once and we are waiting for user confirmation
    confirmation_requested: bool = False
    # Indicates the user explicitly confirmed the collected information
